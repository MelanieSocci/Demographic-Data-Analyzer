...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = (rich_by_country / country_counts * 100).round(1)
    highest_earning_country = highest_earning_country_percentage.idxmax()
    highest_percentage = round(highest_earning_country_percentage.max(), 1)
    ...
    return {
        ...
        'highest_earning_country_percentage':float(highest_percentage),
